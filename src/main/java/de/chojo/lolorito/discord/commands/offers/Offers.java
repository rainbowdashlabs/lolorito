        ...
        super(Slash.of("offers", "The best offers for your world")
                ...
                .subCommand(SubCommand.of("filter", "Configure the filter")
                        ...
                        .argument(Argument.integer("min_profit", "The min profit")
                                          .min(5))
                        .argument(Argument.number("min_popularity", "The min popularity")
                                          .min(5))
                        .argument(Argument.integer("min_refresh_hours", "The max age of the listing")
                                          .min(1).max(120))
                        .argument(Argument.number("min_market_volume", "The min volume of the item in the market on your world")
                                          .min(0).max(100))
                        .argument(Argument.number("min_interest", "The minimum interest into the item on your world")
                                          .min(0).max(100))
