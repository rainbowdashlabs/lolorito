...
dependencies {
    ...
    implementation("de.chojo.sadu", "sadu-queries", "2.3.8")
    implementation("de.chojo.sadu", "sadu-updater", "2.3.8")
    implementation("de.chojo.sadu", "sadu-postgresql", "2.3.8")
    implementation("de.chojo.sadu", "sadu-datasource", "2.3.8")
