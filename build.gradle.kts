...
dependencies {
    ...
    implementation("de.chojo.sadu", "sadu-queries", "2.2.1")
    implementation("de.chojo.sadu", "sadu-updater", "2.2.1")
    implementation("de.chojo.sadu", "sadu-postgresql", "2.2.1")
    implementation("de.chojo.sadu", "sadu-datasource", "2.2.1")
